...
2. Wait, you just generated the words on Sparrow… So, maybe it is saved on the machine as well in binary form? [Let’s check!] todo: link to images
3. Look, there it is!
4. Now create 2 backups instead of one and put them to different places
    1. Paper lamination adds some protection to paper
5. From now on, operate under the assumption that you are NOT protected by computers if all of your physical backups are destroyed!
...
6. Optional: Check advice for ordering Bitcoin-related things online[link]
7. Order metal plates to defend against all kinds of degradation[link]
...
4. Install [Sparrow](https://sparrowwallet.com) on the desktop or [Samourai wallet](https://samouraiwallet.com) on and recover your wallet 
...
2. The better way is to find the location where sparrow stores your wallet data and **erase** it **with** the shred **command**
    ...
    2. cd ~/.sparrow/signet/wallets
    3. sudo shred -zvu -n 5 &lt;your_wallet_file_name>
...
2. Do it from the terminal
    1. sudo apt remove sparrow
3. Now delete all the downloaded files (for real, please)
    2. cd ~/Downloads
    3. rm *sparrow*
4. Download files again from the [Sparrow wallet website](https://sparrowwalet.com)
5. There is something really strange with this website, don’t you think?
...
2. 💡 Check advice for [ordering bitcoin related things](/pleb-lessons/#ordering-bitcoin-related-things-online)
...
5. Order endurance-type microSD cards, no need for huge capacity. Order a few spare pieces for later assignments
6. Order a multifunctional sd card reader for your desktop
7. Look at how the device is powered (no USB cables remember) and order batteries too. SeedSigner has its own power supply
8. Don't be cheap. Buy reputable brands to save you from the headache
...
1. Boot into Ubuntu Live
    ...
    3. You might have to change the boot order in the BIOS settings
...
3. Find your brand and select “Scan”
...
12. Add an encryption password of your choice
...
4. Verify receiving address on the hardware wallet[images]
